...
<div class="container mt-5">
    <h2 class="mb-4">Zona Skates</h2>

    <!-- Barra de búsqueda -->
    <input type="text" id="buscador" placeholder="Buscar producto por nombre..." class="form-control form-control-lg">
<div class="row mb-4">
    <div class="col-md-4">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card h-100">
                            ...
                            <div class="card-body text-center">
                                ...
                                <form action="${pageContext.request.contextPath}/AñadirCarritoServlet" method="post">
